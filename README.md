...
```swift
.package(url: "https://github.com/moq-dev/moq-swift", from: "0.2.31"),
```

The package depends on a prebuilt `MoqFFI.xcframework` attached to the matching [moq-ffi-v0.2.31](https://github.com/moq-dev/moq/releases/tag/moq-ffi-v0.2.31) release on the source repo.
