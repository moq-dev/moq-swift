...
The package depends on a prebuilt `MoqFFI.xcframework` attached to the matching [moq-ffi-v0.2.27](https://github.com/moq-dev/moq/releases/tag/moq-ffi-v0.2.27) release on the source repo.
