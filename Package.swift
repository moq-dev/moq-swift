...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MoqFFIBinary",
            url: "https://github.com/moq-dev/moq/releases/download/moq-ffi-v0.2.19/MoqFFI.xcframework.zip",
            checksum: "0e4229ef0d578cb5dd81a5130747c90d8429a34f7676a189b44f032985795da7"
        ),
