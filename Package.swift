...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MoqFFIBinary",
            url: "https://github.com/moq-dev/moq/releases/download/moq-ffi-v0.2.27/MoqFFI.xcframework.zip",
            checksum: "cab9598d1cfa7f6f18842805589ea18a1d6b262886407e5ff4896221ed8f44ee"
        ),
